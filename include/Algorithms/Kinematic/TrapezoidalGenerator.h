...
namespace Kub3::Algorithms::Kinematic
{
    ...
    public:
        ...
        void startPositionMove(
            ...
            double maxVelocity,
            double acceleration,
            double precisionMm = DEFAULT_PRECISION_MM) override;
        ...
        void updatePositionMove(double targetPosition, double maxVelocity, double acceleration, double precisionMm) override;
        ...
        [[nodiscard]] Mode getMode() const noexcept override
        {
            return m_mode;
        }

    private:
        void positionModeComputeNext(double dt);
        void velocityModeComputeNext(double dt);
    ...
    private:
        ...
        double m_precisionMm    = DEFAULT_PRECISION_MM;
