...
#define CONF_PROCESS_X_STAGE_RESET_POS_MM     "x_stage_reset_pos_mm"
#define CONF_PROCESS_Y_STAGE_RESET_POS_MM     "y_stage_reset_pos_mm"
#define CONF_PROCESS_THETA_STAGE_RESET_POS_MM "theta_stage_reset_pos_mm"
