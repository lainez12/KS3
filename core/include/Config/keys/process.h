...
#define CONF_PROCESS_LEFT_CAM_LIGHTING_STEP_PC  "left_cam_lighting_step_pc"
#define CONF_PROCESS_RIGHT_CAM_LIGHTING_STEP_PC "right_cam_lighting_step_pc"
#define CONF_PROCESS_LEFT_CAM_FOCAL_STEP_PC     "left_cam_focal_step_pc"
#define CONF_PROCESS_RIGHT_CAM_FOCAL_STEP_PC    "right_cam_focal_step_pc"
